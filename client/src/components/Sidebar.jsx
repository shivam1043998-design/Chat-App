...
const Sidebar = () => {
  ...
  return (
    <div className={`bg-[#81815B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? 'max-md:hidden' : ''}`}>
        <div className="pb-5">
            ...
            <div className="bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5">
                <img onClick={(e)=>setInput(e.target.value)} src={assets.search_icon} alt="Search" className="w-3" />
        ...
        <div className="flex flex-col">
            {filteredUsers.map((user,index)=>(
                <div onClick={()=>{setSelectedUser(user)}}  key={index} className={`relative flex item-center gap-2 p-2 pl-4 rounded cursor-pointer max-sm:text-sm
